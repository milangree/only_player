...
class SelectionManager(
    ...
    fun isFolderSelected(folder: Folder): Boolean = selectedFolders.find { it.path == folder.path } != null

    fun isVideoSelected(video: Video): Boolean = selectedVideos.find { it.uriString == video.uriString } != null
